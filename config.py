...
# Świeżość liczona w DNIACH ROBOCZYCH (nie kalendarzowych — inaczej fałszywe stale_safe
# w poniedziałki: FRED publikuje z lagiem ~1 dnia roboczego, w pon. wieczorem ostatnia
# wartość to piątek = 72 h kalendarzowe). Osobne progi bo FRED ma większy lag publikacji.
STALE_CORE_MAX_BDAYS = int(os.environ.get("STALE_CORE_MAX_BDAYS", "2"))  # ceny CORE
STALE_FRED_MAX_BDAYS = int(os.environ.get("STALE_FRED_MAX_BDAYS", "3"))  # makro FRED
